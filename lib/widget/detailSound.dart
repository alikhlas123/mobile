...
class DetailSound extends StatefulWidget {
  const DetailSound({Key? key}) : super(key: key);

  @override
  State<DetailSound> createState() => _detailSound();
}

class _detailSound extends State<DetailSound> {
  late Future<List<FirebaseFile>> futureFiles;

  @override
  void initState() {
    super.initState();
    futureFiles = FirebaseApi.listAll('filesound/detail');
  }
